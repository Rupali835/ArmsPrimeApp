//
//  RescheduleVideoCallDateCollectionCell.swift
//  Producer
//
...
class RescheduleVideoCallDateCollectionCell: UICollectionViewCell {
    ...
    func setDetails(currentDate: Date, offset: Int, selectedDate: Date) {
        ...
        if let date = currentDate.dateByAdding(day: offset) {
            ...
            if date.compare(selectedDate) == .orderedSame {
                ...
                viewContainer.backgroundColor = appearences.yellowColor
