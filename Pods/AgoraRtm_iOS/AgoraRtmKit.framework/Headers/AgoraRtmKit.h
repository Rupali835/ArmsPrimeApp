 ...
 **NOTE**
 ...
 - The server will never return the `unreachable` state, if you <i>query</i> the online status of specified peer(s) ([queryPeersOnlineStatus]([AgoraRtmKit queryPeersOnlineStatus:completion:])). See also: [AgoraRtmSubscriptionRequestBlock](AgoraRtmSubscriptionRequestBlock).
 ...
 **NOTE**
 ...
 - Punction characters and other symbols, including: "!", "#", "$", "%", "&", "(", ")", "+", "-", ":", ";", "<", "=", ".", ">", "?", "@", "[", "]", "^", "_", " {", "}", "|", "~", ","
 ...
 **NOTE**
 ...
 You can create multiple `AgoraRtmChannel` instances in an `AgoraRtmKit` instance. But you can only join a maximum of 20 channels at the same time. As a good practice, Agore recommends calling the [destroyChannelWithId]([AgoraRtmKit destroyChannelWithId:]) method to release all resources of an RTM channel that you no longer use.
...
/**
 ...
 - If more than one user can update the channel attributes, then Agore recommends calling [getChannelAttributes]([AgoraRtmKit getChannelAllAttributes:completion:]) to update the cache before calling this method.
