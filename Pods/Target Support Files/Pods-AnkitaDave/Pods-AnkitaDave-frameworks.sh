...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/MoEngage-iOS-SDK/Frameworks/MoEngage/MoEngage.framework"
  install_framework "${PODS_ROOT}/MoEngage-iOS-SDK/Frameworks/MoEngageCore/MoEngageCore.framework"
  install_framework "${PODS_ROOT}/MoEngage-iOS-SDK/Frameworks/MoEngageAnalytics/MOAnalytics.framework"
  install_framework "${PODS_ROOT}/MoEngage-iOS-SDK/Frameworks/MoEngageMessaging/MOMessaging.framework"
